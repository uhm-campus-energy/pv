...
input_dir = project_root / "data" / "gartley_alsoenergy"
...
df_cleaned = df[['Site Time', 'PV Inverter active power Kilowatts']].copy()
df_cleaned = df_cleaned.rename(columns={
    'Site Time': 'datetime',
    'PV Inverter active power Kilowatts': 'power_avg_kw'
})
...
output_csv = output_dir / f"gartley_pv_cleaned_{start_date}_{end_date}_{freq}.csv"
