...
input_dir = project_root / "data" / "frog1_egauge"
...
print("=" * 80)
print("CLEANING FROG1 SUBMETER DATA")
print("=" * 80)
...
output_csv = output_dir / f"frog1_pv_cleaned_{start_date}_{end_date}_{freq}.csv"
