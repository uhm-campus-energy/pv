...
# File paths
input_csv = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\parking_phase2.csv"
output_csv = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\cleaned\parking_phase2_pv_cleaned.csv"
dates_csv_path = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\dates_pv_power.csv"
## when done upload to table from command line using folder on server, eg. \copy pv.pv_power (sensor_id,meter_name,datetime,power_avg_kw) from '/home/eileen/uploads_uhm/parkingphase2_pv_cleaned.csv' CSV HEADER;

meter_name = "parking_phase2_pv"

print("=" * 80)
print("CLEANING PARKING PHASE 2 PV DATA")
print("=" * 80)
...
df_cleaned = df[['Site Time', 'Inverter active power Kilowatts']].copy()
df_cleaned = df_cleaned.rename(columns={
    'Site Time': 'datetime',
    'Inverter active power Kilowatts': 'power_avg_kw'
})

# Add new columns with specified values
df_cleaned['sensor_id'] = 7
