...
# File paths
input_csv = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\bachman\data.csv"
output_csv = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\cleaned\bachman_pv_cleaned.csv"
dates_csv_path = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\dates_pv_power.csv"
## when done upload to table from command line using folder on server, eg. \copy pv.pv_power (sensor_id,meter_name,datetime,power_avg_kw) from '/home/eileen/uploads_uhm/bachman_pv_cleaned.csv' CSV HEADER;

meter_name = "bachman_pv"

print("=" * 80)
print("CLEANING BACHMAN SUBMETER DATA")
print("=" * 80)
