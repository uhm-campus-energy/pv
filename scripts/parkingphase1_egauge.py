...
input_dir = project_root / "data" / "parkingphase1_egauge"
...
meter_name = 'parking_phase1_pv'
## when done upload to table from command line using folder on server, eg. \copy pv.pv_power (sensor_id,meter_name,datetime,power_avg_kw) from '/home/eileen/uploads_uhm/parkingphase1_pv_cleaned.csv' CSV HEADER;


print("=" * 80)
print("CLEANING PARKING PHASE 1 PV DATA")
print("=" * 80)
...
# Convert datetime to MM/DD/YYYY HH:MM:SS format
...
output_csv = output_dir / f"parkingphase1_pv_cleaned_{start_date}_{end_date}_{freq}.csv"
