...
# File paths
input_csv = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\gyms-1-2\data.csv"
output_csv = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\cleaned\gyms_1_2_pv_cleaned.csv"
dates_csv_path = r"C:\Users\EileenPeppard\Desktop\2026-03-24_PV_data\dates_pv_power.csv"
## when done upload to table from command line using folder on server, eg. \copy pv.pv_power (sensor_id,meter_name,datetime,power_avg_kw) from '/home/eileen/uploads_uhm/gym_pv_cleaned.csv' CSV HEADER;

# NOTE: 'gym_pv' was not found in dates_pv_power.csv. sensor_id 13 maps to 'hyper_pv'
# (Gyms 1&2 / HPER). Please confirm meter_name below is correct before running.
meter_name = "hyper_pv"

print("=" * 80)
print("CLEANING GYM SUBMETER DATA")
print("=" * 80)
...
df_cleaned = df[['Date & Time', 'Generation [kW]']].copy()
df_cleaned = df_cleaned.rename(columns={
    'Date & Time': 'datetime',
    'Generation [kW]': 'power_avg_kw'
})

# Add new columns with specified values
df_cleaned['sensor_id'] = 13
