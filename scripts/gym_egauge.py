...
input_dir = project_root / "data" / "gym1,2_egauge"
...
meter_name = "gyms1,2_pv"  # sensor_id 13, Gyms 1&2 / HPER — matches dates_pv_power.csv
...
output_csv = output_dir / f"gyms_1_2_pv_cleaned_{start_date}_{end_date}_{freq}.csv"
